...
//     `true` or `false`
//
let access = false; // replace null with your response
//
...
// executing it.
//
let fireOnAlderaan = function (deathStar, alderaan) {
  console.log(deathStar.fire.bind(alderaan));
};
fireOnAlderaan(deathStar, alderaan);
